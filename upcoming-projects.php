        ...
        <div class="d-flex flex-column flex-lg-row row-cols-2 gap-40">
                ...
                <div class="py-20">
                    ...
                    <div class="row g-3">
                        <div class="col-auto wmin-100 col-xl-6">
                            <button type="button" class="btn theme-text-sm p-10 w-100 bg-light-10 rounded-pill text-uppercase">Most Popular</button>
                        </div>
                        <div class="col-auto wmin-100 col-xl-6">
                            <button type="button" class="btn theme-text-sm p-10 w-100 bg-light-10 rounded-pill text-uppercase text-primary">Upcoming</button>
                        </div>
                        <div class="col-auto wmin-100 col-xl-6">
                            <button type="button" class="btn theme-text-sm p-10 w-100 bg-light-10 rounded-pill text-uppercase">Recently Closed</button>
                        </div>
                        <div class="col-auto wmin-100 col-xl-6">
                            <button type="button" class="btn theme-text-sm p-10 w-100 bg-light-10 rounded-pill text-uppercase">Minting Soon</button>
                        </div>
                    </div>
                </div>
                <div class="py-20">
                    ...
                    <div class="row g-3">
                        <div class="col-auto wmin-100 col-xl-6">
                            <button type="button" class="btn theme-text-sm p-10 w-100 bg-light-10 rounded-pill text-uppercase">All</button>
                        </div>
                        <div class="col-auto wmin-100 col-xl-6">
                            <button type="button" class="btn theme-text-sm p-10 w-100 bg-light-10 rounded-pill text-uppercase">Ethereum</button>
                        </div>
                        <div class="col-auto wmin-100 col-xl-6">
                            <button type="button" class="btn theme-text-sm p-10 w-100 bg-light-10 rounded-pill text-uppercase">Solana</button>
                        </div>
                        <div class="col-auto wmin-100 col-xl-6">
                            <button type="button" class="btn theme-text-sm p-10 w-100 bg-light-10 rounded-pill text-uppercase">Flow</button>
                        </div>
                        <div class="col-auto wmin-100 col-xl-6">
                            <button type="button" class="btn theme-text-sm p-10 w-100 bg-light-10 rounded-pill text-uppercase">Polygon</button>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-12 col-lg-8">
                <div class="row g-4">
                    ...
                    <div class="col-md-6 col-lg-12 col-xl-6 d-flex gap-20">
                        <img src="/assets/images/nft_2.png" class="nft-project-item-img" style="max-width: 200px; aspect-ratio: 1;" alt="">
                        <div class="d-flex flex-column justify-content-between">
                            <div>
                                <p class="theme-text-body mt-2">Feb 22, 2023</p>
                                <h5 class="theme-text-lg theme-fw-700 my-2">xHamsterNFT</h5>
