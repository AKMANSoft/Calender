    ...
    <div id="wrapper">
        ...
        <div class="navbar-custom">
            <div class="container-fluid">
                <ul class="d-none list-unstyled topnav-menu float-end mb-0">
                    ...
                    <li class="d-none dropdown d-inline-block d-lg-none">
                    ...
                    <li class="d-none dropdown d-none d-lg-inline-block">
                    ...
                    <li class="d-none dropdown notification-list topbar-dropdown">
                    ...
                    <li class="d-none dropdown notification-list">
            ...
            <div class="h-100" data-simplebar>
                ...
                <div id="sidebar-menu">
                    ...
                    <ul id="side-menu">
                        ...
                        <li>
                            <a href="#sidebarOpt" data-bs-toggle="collapse">
                                <i data-feather="layers"></i>
                                <span> Projects </span>
                                <span class="menu-arrow"></span>
                            </a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            <div class="avatar-lg rounded-circle bg-soft-success border-success border">
                                                <i class="dripicons-checkmark font-22 avatar-title text-success"></i>
                                            </div>
                                        </div>
                                    </div> <!-- end row-->
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            <div class="avatar-lg rounded-circle bg-soft-warning border-warning border">
                                                <i class="dripicons-document font-22 avatar-title text-warning"></i>
                                            </div>
                                        </div>
                                    </div> <!-- end row-->
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-8">
                                            <div class="text-start">
                                                <h3 class="text-dark mt-1"><span data-plugin="counterup">100</span></h3>
                                                <p class="text-muted mb-1 text-start">Total number of <br> featured
                                                    projects</p>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="avatar-lg rounded-circle bg-soft-warning border-warning border">
                                                <i class="dripicons-star font-22 avatar-title text-warning"></i>
                                            </div>
                                        </div>
                                    </div> <!-- end row-->
                                </div>
