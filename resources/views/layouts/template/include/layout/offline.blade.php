                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">Offline</h4>
                                        ...
                                        <thead>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $proj->proj_chain }}</td>
                                                    <td>{{ $proj->total_supply }}</td>
                                                    <td>{{ $proj->proj_description }} </td>
                                                    <td>{{ $proj->url }}</td>
                                                    <td>{{ $proj->time_zone }}</td>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            ...
                                                            @csrf
                                                            <input name="id" value="{{ $proj->id }}" class="d-none">
                                                            <input class="btn btn-warning" type="submit" name="submit" value="View" onClick="window.location.reload()">
                                                            </form>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <form action="{{ url('/') }}/project-approved-update" method="post">
                                                            @csrf
                                                            <input name="id" value="{{ $proj->id }}" class="d-none">
                                                            <input class="btn btn-success" type="submit" name="submit" value="Approve" onClick="window.location.reload()">
                                                            </form>
                                                        ...
                                                        <div class="col-md-3">
                                                             ...
                                                             <form action="{{ url('/') }}/project-rejected-update" method="post">
                                                            @csrf
                                                            <input name="id" value="{{ $proj->id }}" class="d-none">
                                                            <input class="btn btn-danger" type="submit" name="submit" value="Reject" onClick="window.location.reload()">
                                                            </form>
