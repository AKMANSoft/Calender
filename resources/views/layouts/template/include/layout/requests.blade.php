                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <form action="{{ url('/') }}/profile" method="post">
                                                        ...
                                                        <input type="submit" name="submit" class="btn btn-warning" value="Preview">
                                                    </form>
                                                    
                                                    <a class="btn btn-success">Approved</a> <a class="btn btn-danger">Rejected</a> </td>
                                                </tr>
                                            </tbody>
                                            @endforeach
                                        </table>
