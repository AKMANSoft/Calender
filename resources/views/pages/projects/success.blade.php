...
<main class="mx-auto mt-160 px-60-auto mb-100" style="max-width: 1220px">
    <div class="text-center">
        ...
        <p class="theme-fw-700">Step 2: Select Your Verification Level</p>
    </div>
    <div class="mt-90 row gx-4 gx-lg-5 gy-4 gy-md-0 mx-auto h-100" style="max-width: 900px;">
        <div class="col-md-6">
            <div class="d-flex flex-column justify-content-between bg-white-10 p-30 rounded-3 h-100" style="min-height: 360px">
                <div>
                    <div class='row align-items-center gx-3 pb-35'>
                        <p class="text-light theme-text-lg theme-fw-700 col-auto">Free Basic Verification</p>
                        <img src="/assets/images/icons/verified_icon.svg" height="27" alt="" class="col-auto" />
                    </div>
                    <h3 class="fs-32 fw-bold text-primary pt-2 pb-2 border-vertical-muted">Free</h3>
                    ...
                    <ul class='pt-20 list-group'>
                        ...
                        <li class="text-light mb-3 d-flex theme-text-sm p-0" style="gap: 10px; list-style: none;">
                            ...
                            <span class="theme-fw-400">
                                ...
                                Post <a href="#" class="text-primary" onclick="openImageInNewTab('https://picsum.photos/200/300')">this small image</a> in your website's footer or other, hyperlinking back to <a class="text-primary" href="https://moonlanding.media/" target="_blank">https://moonlanding.media/</a>.
                            </span>
                        </li>
                        <li class="text-light mb-3 d-flex theme-text-sm p-0" style="gap: 10px; list-style: none;">
                            <span class="bg-light-30 theme-fw-700 mt-1 text-center rounded-circle d-inline-block" style="line-height: 24px; aspect-ratio: 1; min-width: 24px; height: 24px;">
        ...
        <div class="col-md-6">
            <div class="d-flex flex-column justify-content-between bg-white-10 p-30 rounded-3 h-100" style="min-height: 360px">
                <div>
                    <div class='row align-items-center gx-3 pb-35'>
                        <p class="text-light theme-text-lg theme-fw-700 col-auto">Premium KYC Verification</p>
                        <img src="/assets/images/icons/kyc_icon.svg" height="27" alt="" class="col-auto" />
                    </div>
                    <h3 class="fs-32 fw-bold text-primary pt-2 pb-2 border-vertical-muted">0.5 ETH</h3>
                ...
                <div>
                    ...
                    <style>
                        .buy-with-crypto.loading {
                            background: #AB4DAB !important;
                        }
                    </style>
                    <!-- </div> -->
