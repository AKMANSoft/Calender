                ...
                <div>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-20">
                            ...
                            <input type="text" name="name" value="{{ old('name') }}" id="projectName"
                                class="form-control fs-14 shadow-none" placeholder="" required />
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-20">
                            ...
                            <input type="url" value="{{ old('twitter_link') }}" class="form-control fs-14 shadow-none"
                        ...
                        <div class="col-md-4 mb-20">
                            ...
                            <input value="{{ old('website_url') }}" type="url" class="form-control fs-14 shadow-none"
                ...
                <div class="">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-20">
                            ...
                            <input value="{{ old('pre_sale_date') }}" type="text" id="basic-datepicker"
                                class="form-control fs-14 shadow-none" placeholder="Choose date" name="pre_sale_date" />
                        ...
                        <div class="col-md-4 mb-20">
                            ...
                            <input value="{{ old('pre_sale_time') }}" type="text" id="preloading-timepicker"
                                class="form-control fs-14 shadow-none" placeholder="Choose date" name="pre_sale_time" />
                            <div id="invalidfeedback5" class="text-danger">
                                @error('pre_sale_time')
                                    {{ $message }}
                                @enderror
                        ...
                        <div class="col-md-4 mb-20">
                            ...
                            <div class="input-group">
                                <input value="{{ old('pre_sale_price') }}" type="text"
                                    class="form-control fs-14 shadow-none" placeholder="Enter price"
                                    name="pre_sale_price" />
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-20">
                            <label class="form-label fs-14 text-light-70 mb-10">Mint date <span
                                    class="ms-1 text-danger">*</span></label>
                            <input value="{{ old('mint_date') }}" type="text" id="humanfd-datepicker"
                                class="form-control fs-14 shadow-none" placeholder="Choose date" name="mint_date"
                                required />
                            <div id="invalidfeedback5" class="text-danger">
                                @error('mint_date')
                                    {{ $message }}
                        ...
                        <div class="col-md-4 mb-20">
                            <label class="form-label fs-14 text-light-70 mb-10">Mint time <span
                                    class="ms-1 text-danger">*</span></label>
                            <input value="{{ old('mint_time') }}" type="text" id="minmax-timepicker"
                                class="form-control fs-14 shadow-none" placeholder="Choose date" name="mint_time"
                                id="time" required />
                        ...
                        <div class="col-md-4 mb-20">
                            <label class="form-label fs-14 text-light-70 mb-10">Mint price <span
                                    class="ms-1 text-danger">*</span></label>
                            <div class="input-group">
                                <input value="{{ old('mint_price') }}" type="text"
                                    class="form-control fs-14 shadow-none" placeholder="Enter price" name="mint_price"
                                    id="price" required />
                                <span class="input-group-text bg-transparent">ETH</span>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-20">
                            ...
                            <input value="{{ old('founder_name') }}" type="text"
                                class="form-control fs-14 shadow-none" name="founder_name" />
                        ...
                        <div class="col-md-4 mb-20">
                            ...
                            <input value="{{ old('founder_email') }}" type="email"
                                class="form-control fs-14 shadow-none" name="founder_email" id="founderEmail" required />
                            <div id="invalidfeedback8" class="text-danger">
                                @error('founder_email')
                                    {{ $message }}
                                @enderror
                        ...
                        <div class="col-md-4 mb-20">
                            ...
                            <input value="{{ old('founder_phone') }}" type="number"
                                class="form-control fs-14 shadow-none" name="founder_phone" />
                            <div id="invalidfeedback8" class="text-danger">
                                @error('founder_phone')
                                    {{ $message }}
                                @enderror
