            ...
            <form class="needs-validation" novalidate method="POST" enctype="multipart/form-data"
                ...
                <div>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-20">
                            ...
                            <input type="text" name="name" value="{{ old('name') }}" id="projectName"
                                class="form-control bg-transparent fs-14 shadow-none" placeholder="" required />
                        ...
                        <div class="col-md-4 mb-20">
                            <label class="form-label fs-14 text-light-70 mb-10">Total supply <span
                                    class="ms-1 text-danger">*</span></label>
                            <input type="number" class="form-control fs-14 shadow-none bg-transparent" placeholder=""
                                name="total_supply" id="totalSupply" required value="{{ old('total_supply') }}" />
                    ...
                    <div class="row mb-20">
                        <div>
                            <label class="form-label fs-14 text-light-70 mb-10">Project description <span
                                    class="ms-1 text-danger">*</span></label>
                            <textarea class="form-control fs-14 shadow-none bg-transparent" rows="6" placeholder="" name="description"
                                id="projectDesc" required>{{ old('description') }}</textarea>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-20">
                            ...
                            <input type="url" value="{{ old('twitter_link') }}"
                                class="form-control fs-14 shadow-none bg-transparent"
                                pattern="(https?:\/\/(?:www\.|(?!www))[a-zA-Z0-9][a-zA-Z0-9-]+[a-zA-Z0-9]\.[^\s]{2,}|www\.[a-zA-Z0-9][a-zA-Z0-9-]+[a-zA-Z0-9]\.[^\s]{2,}|https?:\/\/(?:www\.|(?!www))[a-zA-Z0-9]+\.[^\s]{2,}|www\.[a-zA-Z0-9]+\.[^\s]{2,})"
                                placeholder="Enter URL" name="twitter_link" />
                            <div id="invalidfeedback3" class="text-danger">
                                @error('twitter_link')
                                    {{ $message }}
                                @enderror
                        ...
                        <div class="col-md-4 mb-20">
                            ...
                            <input value="{{ old('discord_link') }}" type="url"
                                class="form-control fs-14 shadow-none bg-transparent"
                                pattern="(https?:\/\/(?:www\.|(?!www))[a-zA-Z0-9][a-zA-Z0-9-]+[a-zA-Z0-9]\.[^\s]{2,}|www\.[a-zA-Z0-9][a-zA-Z0-9-]+[a-zA-Z0-9]\.[^\s]{2,}|https?:\/\/(?:www\.|(?!www))[a-zA-Z0-9]+\.[^\s]{2,}|www\.[a-zA-Z0-9]+\.[^\s]{2,})"
                        ...
                        <div class="col-md-4 mb-20">
                            ...
                            <input value="{{ old('website_url') }}" type="url"
                                class="form-control fs-14 shadow-none bg-transparent"
                                pattern="(https?:\/\/(?:www\.|(?!www))[a-zA-Z0-9][a-zA-Z0-9-]+[a-zA-Z0-9]\.[^\s]{2,}|www\.[a-zA-Z0-9][a-zA-Z0-9-]+[a-zA-Z0-9]\.[^\s]{2,}|https?:\/\/(?:www\.|(?!www))[a-zA-Z0-9]+\.[^\s]{2,}|www\.[a-zA-Z0-9]+\.[^\s]{2,})"
                                placeholder="Enter URL" name="website_url" />
                            <div id="invalidfeedback3" class="text-danger">
                                @error('website_url')
                                    {{ $message }}
                                @enderror
                ...
                <div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-control-image-container cursor-pointer col-md-6 mb-20">
                            <label for="banner_image_path" class="form-label fs-14 text-light-70 mb-10">Banner Image <span
                ...
                <div class="">
                    ...
                    <div class="row">
                        <div class="col mb-20">
                            <label class="form-label fs-14 text-light-70 mb-10">Timezone <span
                                    class="ms-1 text-danger">*</span></label>
                            <select class="form-select fs-14 shadow-none" name="pre_sale_timezone" id="timeZone"
                                required>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-20">
                            ...
                            <input value="{{ old('pre_sale_date') }}" type="date" id=""
                                class="form-control fs-14 shadow-none bg-transparent" placeholder="Choose date"
                                name="pre_sale_date" />
                        ...
                        <div class="col-md-4 mb-20">
                            ...
                            <input value="{{ old('pre_sale_time') }}" type="time"
                                class="form-control fs-14 shadow-none bg-transparent" placeholder="Choose date"
                                name="pre_sale_time" />
                            <div id="invalidfeedback5" class="text-danger">
                                @error('pre_sale_time')
                        ...
                        <div class="col-md-4 mb-20">
                            ...
                            <div class="input-group">
                                <input value="{{ old('pre_sale_price') }}" type="number"
                                    class="form-control fs-14 shadow-none bg-transparent" placeholder="Enter price"
                                    name="pre_sale_price" />
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-20">
                            <label class="form-label fs-14 text-light-70 mb-10">Mint date <span
                                    class="ms-1 text-danger">*</span></label>
                            <input value="{{ old('mint_date') }}" type="date"
                                class="form-control fs-14 shadow-none bg-transparent" placeholder="Choose date"
                                name="mint_date" required />
                            <div id="invalidfeedback5" class="text-danger">
                                @error('mint_date')
                                    {{ $message }}
                                @enderror
                        ...
                        <div class="col-md-4 mb-20">
                            <label class="form-label fs-14 text-light-70 mb-10">Mint time <span
                                    class="ms-1 text-danger">*</span></label>
                            <input value="{{ old('mint_time') }}" type="time"
                                class="form-control fs-14 shadow-none bg-transparent" placeholder="Choose date"
                                name="mint_time" id="time" required />
                        ...
                        <div class="col-md-4 mb-20">
                            <label class="form-label fs-14 text-light-70 mb-10">Mint price <span
                                    class="ms-1 text-danger">*</span></label>
                            <div class="input-group">
                                <input value="{{ old('mint_price') }}" type="number"
                                    class="form-control fs-14 shadow-none bg-transparent" placeholder="Enter price"
                ...
                <div class="">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-20">
                            ...
                            <input value="{{ old('founder_name') }}" type="text"
                                class="form-control fs-14 shadow-none bg-transparent" name="founder_name" />
                        ...
                        <div class="col-md-4 mb-20">
                            <label class="form-label fs-14 text-light-70 mb-10">Email <span
                                    class="ms-1 text-danger">*</span></label>
                            <input value="{{ old('founder_email') }}" type="email"
                                class="form-control fs-14 shadow-none bg-transparent"
                                pattern="^[\w]{1,}[\w.+-]{0,}@[\w-]{2,}([.][a-zA-Z]{2,}|[.][\w-]{2,}[.][a-zA-Z]{2,})$"
                                name="founder_email" id="founderEmail" required />
                            <div id="invalidfeedback8" class="text-danger">
                                @error('founder_email')
                                    {{ $message }}
                                @enderror
                        ...
                        <div class="col-md-4 mb-20">
                            ...
                            <input value="{{ old('founder_phone') }}" type="number"
                                class="form-control fs-14 shadow-none bg-transparent" name="founder_phone" />
                            <div id="invalidfeedback8" class="text-danger">
                                @error('founder_phone')
                                    {{ $message }}
                                @enderror
