                ...
                <div>
                    ...
                    <div class="mt-80">
                        ...
                        <div class="row mt-2 g-2">
                            <div class="col-auto">
                                <a href="{{ route('projects.index', ['category' => 'most popular', 'chain' => 'all']) }}"
                                    class="btn bg-light-10 text-uppercase rounded-pill py-2 px-3 theme-text-sm theme-fw-400">
                                    Most Popular
                                </a>
                            </div>
                            <div class="col-auto">
                                <a href="{{ route('projects.index', ['category' => 'upcoming', 'chain' => 'all']) }}"
                                    class="btn bg-light-10 text-uppercase rounded-pill py-2 px-3 theme-text-sm theme-fw-400">
                                    Upcoming
                                </a>
                            </div>
                            <div class="col-auto">
                                <a href="{{ route('projects.index', ['category' => 'recently closed', 'chain' => 'all']) }}"
                                    class="btn bg-light-10 text-uppercase rounded-pill py-2 px-3 theme-text-sm theme-fw-400">
                                    Recently Closed
                                </a>
                            </div>
                            <div class="col-auto">
                                <a href="{{ route('projects.index', ['category' => 'minting soon', 'chain' => 'all']) }}"
                                    class="btn bg-light-10 text-uppercase rounded-pill py-2 px-3 theme-text-sm theme-fw-400">
                                    Minting Soon
                                </a>
                            </div>
            ...
            <div class="col-lg-6 mt-5 mt-lg-0 d-flex flex-column align-items-center align-items-lg-end p-0">
                <div class="nft-cards-carousel w-100 wmax-lg-540">
                    <div class="glide__track" data-glide-el="track">
                            ...
                            @forelse ($featuredProjects as $project)
                                ...
                                <li class="glide__slide">
                                    <div class="fetured_project_slider_card bg-gradient-light">
                                        ...
                                        <img src="{{ asset('storage') }}/{{ $project->profile_image_path }}" width="260"
                                            height="260" alt="">
                                        <div class="title">
                                            <h4 class="theme-fw-700">{{ $project->name }}</h4>
                                            @if ($project->is_link_verified && $project->is_dooxed_kyc_verified)
                                                <img src="{{ asset('assets') }}/images/icons/verified_icon.svg"
                                                    width="20" height="20" alt="">
                                                <img src="{{ asset('assets') }}/images/icons/golden_badge.png"
                                                    width="20" height="20" alt="">
                                        ...
                                        <div
                                            class="theme-text-body d-flex align-items-center justify-content-center gap-4 mt-2">
                                        ...
                                        <div class="bg-light px-3 py-2 rounded-pill text-dark mt-3">
                                            <img src="/assets/images/icons/price_icon_dark.svg" width="12"
                                                height="20" alt="">
                                            <span
                                                class="ms-2 theme-text-body text-uppercase">{{ $project->pre_sale_price }}
                                                Ethereum</span>
                                        </div>
                                    </div>
                                </li>
                        ...
                        <div class="mt-4 d-flex gap-3 align-items-center wmax-lg-540 justify-content-center w-100 glide__bullets"
