        ...
        <div>
            ...
            <div class="row">
                <div class="col-md-4 mb-20">
                    ...
                    <input type="text" class="form-control fs-14 shadow-none" placeholder="Enter URL" name="twitter" />
                </div>
                <div class="col-md-4 mb-20">
                    <label class="form-label fs-14 text-light-70 mb-10">Discord Link (Optional)</label>
                    <input type="text" class="form-control fs-14 shadow-none" placeholder="Enter URL"name="discord" />
                </div>
                <div class="col-md-4 mb-20">
                    <label class="form-label fs-14 text-light-70 mb-10">Website Link (Optional)</label>
                    <input type="text" class="form-control fs-14 shadow-none" placeholder="Enter URL" name="url" />
                </div>
            </div>
        </div>
        <!-- Images Section -->
        ...
        <div class="">
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-20">
                    ...
                    <input type="text" class="form-control fs-14 shadow-none" name="founderPhone" />
                </div>
            </div>
        </div>
        <!-- Verification Badge -->
