...
<main class="mt-150">
        ...
        <div class="col-lg-6">
            <div>
                <div class="wmax-lg-540">
                    ...
                    <p class="theme-text-body theme-fw-400 text-light-70">Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
                </div>
                <div class="mt-80">
                    ...
                    <div class="row mt-2 g-2">
                        <div class="col-auto">
                            <button type="button" class="btn bg-light-10 text-uppercase rounded-pill py-2 px-3 theme-text-sm theme-fw-400">Most Popular</button>
                        </div>
                        <div class="col-auto">
                            <button type="button" class="btn bg-light-10 text-uppercase rounded-pill py-2 px-3 theme-text-sm theme-fw-400">Upcoming</button>
                        </div>
                        <div class="col-auto">
                            <button type="button" class="btn bg-light-10 text-uppercase rounded-pill py-2 px-3 theme-text-sm theme-fw-400">Recently Closed</button>
                        </div>
                        <div class="col-auto">
                            <button type="button" class="btn bg-light-10 text-uppercase rounded-pill py-2 px-3 theme-text-sm theme-fw-400">Minting Soon</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="max-1440 px-60-auto mx-auto mb-80 mt-60">
        ...
        <div class="row row-cols-2 row-cols-lg-4 row-cols-xl-5 g-3 g-lg-4">
            <div class="col">
                <button type="button" class="btn w-100 rounded-0 bg-light-10 p-3 text-uppercase theme-text-body">Free Mint</button>
            </div>
            <div class="col">
                <button type="button" class="btn w-100 rounded-0 bg-light-10 p-3 text-uppercase theme-text-body">Free Mint</button>
            </div>
    ...
    <section class="max-1440 px-60-auto mx-auto mt-100">
        ...
        <div class="nft-news-list">
            <div class="col nft-news-item">
                ...
                <h5 class="mt-20 theme-text-lg theme-fw-700">Ut enim ad minim veniam, quis nostrud exercitation ullamc oculpa qui officia deserunt</h5>
            </div>
            <div class="col nft-news-item">
                <img src="/assets/images/nft_3.png" class="img-fluid" alt="">
                <h5 class="mt-20 theme-text-lg theme-fw-700">Ut enim ad minim veniam, quis nostrud exercitation ullamc oculpa qui officia deserunt</h5>
