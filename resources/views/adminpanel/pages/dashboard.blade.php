                            ...
                            <div class="row">
                                <div class="col-8">
                                    <div class="text-start">
                                        <h3 class="text-dark mt-1"><span data-plugin="counterup" class="text-light">
                                                <div style="color: white;"> {{$noOfPublishedProjects}} </div>
                                            </span></h3>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-8">
                                    <div class="text-start">
                                        <h3 class="text-dark mt-1"><span data-plugin="counterup" class="text-light">
                                                <div style="color: white;"> {{$noOfRequestedProjects}} </div>
                                            </span></h3>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-8">
                                    <div class="text-start">
                                        <h3 class="text-dark mt-1"><span data-plugin="counterup" class="text-light">
                                                <div style="color: white;"> {{$noOfFeaturedProjects}} </div>
                                            </span></h3>
