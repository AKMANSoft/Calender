                ...
                <div class="col-lg-4">
                    <div class="widget-rounded-circle card" style="min-height: 750px;">
                        <div class="banner-img">
                            ...
                            @else
                            <img src="{{ asset('assets')}}/images/project_banner_image.png" height="160" style="width: 100%; object-fit: cover; object-position: center;" alt="">
                            @endif
                        </div>
