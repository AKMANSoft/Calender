                                ...
                                <div class="mt-30 px-30">
                                    <div class="form-check form-switch d-flex justify-content-between p-0 mb-2">
                                        ...
                                        <input id="superFeatured" name="is_super_featured"
                                            class="form-check-input shadow-none border-0" type="checkbox"
                                            {{ $project->is_super_featured ? 'checked' : '' }}  role="switch">

                                    </div>
                                    <div class="form-check form-switch d-flex justify-content-between p-0 mb-2">
                                        <label class="theme-text-sm text-light-70 theme-fw-400">Featured</label>
                                        <input id="featured" name="is_featured"
                                            class="form-check-input shadow-none border-0" type="checkbox" role="switch"
                                    ...
                                    <div class="form-check form-switch d-flex justify-content-between p-0 mb-2">
                                        ...
                                        <input id="linksVerified" name="is_link_verified"
                                            class="form-check-input shadow-none border-0" type="checkbox" role="switch"
                                            {{ $project->is_link_verified ? 'checked' : '' }}>
                                    </div>
                                    ...
                                    <div class="form-check form-switch d-flex justify-content-between p-0 mb-2">
                                        ...
                                        <input id="kycVerified" name="is_dooxed_kyc_verified"
                                            class="form-check-input shadow-none border-0" type="checkbox" role="switch"
                                            {{ $project->is_dooxed_kyc_verified ? 'checked' : '' }}>
                                    </div>
                        ...
                        <div>
                            <div class="widget-rounded-circle card p-20 m-0" style="padding-bottom: 50px;">
                                <form>
                                    ...
                                    <div class="mt-40">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 mb-3">
                                                <label class="form-label theme-text-xsm text-light-70 mb-10">Project name
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <label class="form-label theme-text-xsm text-light-70 mb-10">Total supply
                                                    <span class="ms-1 text-danger">*</span></label>
                                                <input name="total_supply" value="{{ $project->total_supply }}"
                                                    type="text"
                                                    class="form-control bg-transparent theme-text-xsm shadow-none"
                                                    placeholder="" />
                                                <div id="invalidfeedback8" class="text-danger">
                                        ...
                                        <div class="row mb-3">
                                            <div>
                                                <label class="form-label theme-text-xsm text-light-70 mb-10">Project
                                                    description
                                                    <span class="ms-1 text-danger">*</span></label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <input name="twitter_link" value="{{ $project->twitter_link }}"
                                                    type="text"
                                                    class="form-control bg-transparent theme-text-xsm shadow-none"
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <label class="form-label theme-text-xsm text-light-70 mb-10">Discord Link
                                                    (Optional)</label>
                                                <input name="discord_link" value="{{ $project->discord_link }}"
                                                    type="text"
                                                    class="form-control bg-transparent theme-text-xsm shadow-none"
                                                    placeholder="Enter URL" />
                                                <div id="invalidfeedback8" class="text-danger">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <label class="form-label theme-text-xsm text-light-70 mb-10">Website Link
                                                    (Optional)</label>
                                                <input name="website_link" value="{{ $project->website_link }}"
                                                    type="text"
                                                    class="form-control bg-transparent theme-text-xsm shadow-none"
                                                    placeholder="Enter URL" />
                                                <div id="invalidfeedback8" class="text-danger">
                                    ...
                                    <div>
                                        ...
                                        <div class="row">
                                            <div class="form-control-image-container cursor-pointer col-md-6 mb-3">
                                                <label class=" form-label theme-text-xsm text-light-70 mb-10">Profile Photo
                                                    <span class="mx-2 text-danger">*</span> Ideal size: 240px X
                                                    240px</label>
                                                <input type="file" name="profile_image_path" class="d-none"
                                                    accept="image/*" />
                                            ...
                                            <div class="form-control-image-container cursor-pointer col-md-6 mb-3">
                                                <label class=" form-label theme-text-xsm text-light-70 mb-10">Banner Image
                                                    <span class="mx-2">(Optional)</span> Ideal size: 1450px X
                                                    320px</label>
                                                <input type="file" name="banner_image_path" class="d-none"
                                                    accept="image/*" />
                                                <div class="form-control-image bg-transparent text-center">
                                                    <img src="{{ asset('assets') }}/images/icons/upload_icon.svg"
                                                        alt="" />
                                    ...
                                    <div class="">
                                        <div>
                                            <h3 class="theme-text-lg theme-fw-700 text-light mt-20 mb-3">Pre-Sale Mint
                                                Details</h3>
                                        </div>
                                        <div class="row">
                                            <div class="col mb-3">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 mb-3">
                                                <label class="form-label theme-text-xsm text-light-70 mb-10">Pre-sale mint
                                                    date
                                                    (Optional)</label>
                                                <input name="pre_sale_date" value="{{ $project->pre_sale_date }}"
                                                    type="date"
                                                    class="form-control bg-transparent theme-text-xsm shadow-none"
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <label class="form-label theme-text-xsm text-light-70 mb-10">Pre-sale mint
                                                    time
                                                    (Optional)</label>
                                                <input name="pre_sale_time"
                                                    value="{{ date('H:i', strtotime($project->pre_sale_time)) }}"
                                                    type="time"
                                                    class="form-control bg-transparent theme-text-xsm shadow-none"
                                                    placeholder="Choose date" />
                                                <div id="invalidfeedback8" class="text-danger">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input name="pre_sale_price" value="{{ $project->pre_sale_price }}"
                                                        type="text"
                                                        class="form-control bg-transparent theme-text-xsm shadow-none"
                                                        placeholder="Enter price" />
                                                    <span class="input-group-text bg-transparent"
                                                        id="chain-category1">ETH</span>
                                                </div>
                                                <div id="invalidfeedback8" class="text-danger">
                                    ...
                                    <div class="">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 mb-3">
                                                <label class="form-label theme-text-xsm text-light-70 mb-10">Mint date
                                                    <span class="ms-1 text-danger">*</span></label>
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <label class="form-label theme-text-xsm text-light-70 mb-10">Mint time
                                                    <span class="ms-1 text-danger">*</span></label>
                                                <input name="mint_time"
                                                    value="{{ date('H:i', strtotime($project->mint_time)) }}"
                                                    type="time"
                                                    class="form-control bg-transparent theme-text-xsm shadow-none"
                                                    placeholder="Choose date" />
                                                <div id="invalidfeedback8" class="text-danger">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <label class="form-label theme-text-xsm text-light-70 mb-10">Mint price
                                                    <span class="ms-1 text-danger">*</span></label>
                                                <div class="input-group">
                                                    <input name="mint_price" value="{{ $project->mint_price }}"
                                                        type="text"
                                                        class="form-control bg-transparent theme-text-xsm shadow-none"
                                                        placeholder="Enter price" />
                                                    <span class="input-group-text bg-transparent"
                                                        id="chain-category2">ETH</span>
                                                </div>
                                                <div id="invalidfeedback8" class="text-danger">
                                                    @error('mint_price')
                                                        {{ $message }}
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 mb-3">
                                                <label class="form-label theme-text-xsm text-light-70 mb-10">Full name
                                                    (Optional)</label>
                                                <input name="founder_name" value="{{ $project->founder_name }}"
                                                    type="text"
                                                    class="form-control bg-transparent theme-text-xsm shadow-none" />
                                                <div id="invalidfeedback8" class="text-danger">
                                                    @error('founder_name')
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <label class="form-label theme-text-xsm text-light-70 mb-10">Email <span
                                                        class="ms-1 text-danger">*</span></label>
                                                <input name="founder_email" value="{{ $project->founder_email }}"
                                                    type="email"
                                                    class="form-control bg-transparent theme-text-xsm shadow-none" />
                                                <div id="invalidfeedback8" class="text-danger">
                                                    @error('founder_email')
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <label class="form-label theme-text-xsm text-light-70 mb-10">Phone no.
                                                    (Optional)</label>
                                                <input name="founder_phone" value="{{ $project->founder_phone }}"
                                                    type="text"
                                                    class="form-control bg-transparent theme-text-xsm shadow-none" />
                                                <div id="invalidfeedback8" class="text-danger">
                                                    @error('founder_phone')
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <h3 class="theme-text-lg mb-4 theme-fw-700 text-light ">
                                            Registerations
                                            <span
                                                class="theme-text-sm theme-fw-400">({{ sizeof($project->eventRagistrations) }})</span>
                                        </h3>
                                        ...
                                        <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                                            ...
                                            <tbody>
                                                @foreach ($project->eventRagistrations as $registration)
                                                    <tr>
                                                        <td class="theme-text-sm theme-fw-400">
                                                            {{ $registration->wallet_address }}</td>
                                                        <td class="theme-text-sm theme-fw-400">
                                                            {{ $registration->twitter_username }}</td>
                                                        <td class="theme-text-sm theme-fw-400">{{ $registration->email }}
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
